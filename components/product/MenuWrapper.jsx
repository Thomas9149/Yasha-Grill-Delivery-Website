...
const MenuWrapper = ({categoryList, productList}) => {
    ...
    return (
        isIPhone ? (
                ...
                <div className="container mx-auto  mb-16">
                    <br/><br/><br/><br/>
                    {
                        ...
                        router.asPath === "/" ?
                            ...
                            </div> : <div className="font-extralight -mt-5 uppercase text-center text-2xl text-black">
                                MENU SELECTION
                            </div>
                    }
                        ...
                        <div className="mt-1 font-mono uppercase text-white">
                            {categoryList &&
                                categoryList.map((category, index) => (
                                    <button
                                        className={`px-6 py-2 ${
                                            index === active && "bg-secondary font-bold text-white uppercase "
                                        } ml-4 rounded-3xl `}
                                        key={category._id}
                                        onClick={() => {
                                            setActive(index);
            ...
            <>
                <div className="mx-auto max-w-screen-2l">
                        ...
                        <div className="-mt-0.1 font-mono uppercase text-black">
                            {categoryList &&
                                categoryList.map((category, index) => (
                                    <button
                                        className={`px-6 py-2 ${
                                            index === active && "bg-amber-500 font-bold text-white uppercase "
                                        } ml-4 rounded-3xl `}
                                        key={category._id}
                                        onClick={() => {
                                            setActive(index);
